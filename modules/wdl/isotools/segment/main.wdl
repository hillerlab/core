...
# ISOTOOLS_SEGMENT — Filter and segment long-read transcripts using iso-segment.
# Filters reads by quality and splits them into high-quality and low-quality
# batches based on transcript completeness.
